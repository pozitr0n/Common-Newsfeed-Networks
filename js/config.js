/* The script for smooth display the page */
...
jQuery(window).load(function() {
	...
	/* Settings */
		...
		var settings = {
			resizeSpeed:	400,		// Speed to resize panel
			fadeSpeed:		200,		// Speed to fade in/out
			sizeFactor:		11.5,		// Size factor
			sizeMin:		15,			// Minimum point size
			sizeMax:		22			// Maximum point size
		};
			...
			// Body
				...
				_body.h5u_reposition = function() {
					if (isTouch && (window.orientation == 0 || window.orientation == 180))
						...
						_wrapper.css('padding-top', (((_window.height() - panels[firstPanelId].height()) / 4) - _nav.height()) + 'px');
				};
